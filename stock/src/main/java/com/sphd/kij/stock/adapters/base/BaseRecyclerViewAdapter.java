package com.sphd.kij.stock.adapters.base;
...
public class BaseRecyclerViewAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (getItemViewType(position) == TYPE_FOOTER) {//如果是加载更多
            if (layoutParams != null) {
                if (layoutParams instanceof StaggeredGridLayoutManager.LayoutParams) {//瀑布流
...
/*    @Override
    ...
    public void addMore(List<T> data) {
        int startPosition = mList.size();//初始的list的长度
        mList.addAll(data);
        Log.e("添加加载的数据", "startPosition=" + startPosition + "mList=" + mList.size());

...
public class StockInfoInternet {
    ...
    public static class ShowapiResBody {
        ...
        public void setStockMarket(StockInfo stockMarket) {
            this.stockMarket = stockMarket;
        }

        public KPic getK_pic() {
            return k_pic;
        }

        public void setK_pic(KPic k_pic) {
            this.k_pic = k_pic;
        }
    }

    /*K线图*/
    public static class KPic {

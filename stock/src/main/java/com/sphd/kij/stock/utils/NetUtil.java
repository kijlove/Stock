...
public class NetUtil {
    ...
    public static boolean isNetworkAvailable() {
        ConnectivityManager connectivityManager = (ConnectivityManager) StockApplication.getAppContext()
    ...
    public static boolean isNetworkErrThenShowMsg() {
        if (!isNetworkAvailable()) {
            ...
            Toast.makeText(StockApplication.getAppContext(), StockApplication.getAppContext().getString(R.string.internet_error),
